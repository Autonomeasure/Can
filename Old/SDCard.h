...
public:
  ...
  void print(char *msg, char *file = "radio_log"); // Write to the buffer
  void print(float msg, char *file = "radio_log"); // Write a float to the buffer
  void print(int msg, char *file = "radio_log"); // Write an int to the buffer
  void print(unsigned int msg, char *file = "radio_log"); // Write an unsigned int to the buffer
  void println(char *msg, char *file = "radio_log"); // Write to the buffer
