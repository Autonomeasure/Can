...
bool Can::begin() {
    ...
    bool b = bmp->begin();
    bool s = sd->begin();
    bool lf = sd->open_radio_log_file();
    return b && m && s && lf;
}
...
void Can::tick() {
    ...
    // Save everything on the SD card
    sd->print(id);
    sd->print(';');
    sd->print(int(bmpTemp * 100));
    sd->print(';');
    sd->print(int(mpuTemp * 100));
    sd->print(';');
    sd->print(pressure / 100); // Convert it to hPa
    sd->print(';');
    sd->print(0.000f);
    sd->print(';');
    sd->print(0.000f);
    ...
    sd->print(0);
    sd->print(';');
    sd->print(int((g.x * (180 / PI)) * 100));
    sd->print(';');
    sd->print(int((g.y * (180 / PI)) * 100));
    sd->print(';');
    sd->print(int((g.z * (180 / PI)) * 100));
    sd->print(';');
    sd->print(int((a.x * (180 / PI)) * 100));
    sd->print(';');
    sd->print(int((a.y * (180 / PI)) * 100));
    sd->print(';');
    sd->print(int((a.z * (180 / PI)) * 100));
    sd->print(';');
    sd->print("AAAA");
    sd->println(";");
